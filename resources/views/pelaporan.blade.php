                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($pengaduans as $pengaduan)
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                {{ $pengaduan->nib ?? 'N/A' }}</td> <!-- NIB atau jenis data lainnya -->
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><a
                                                    href="{{ $pengaduan->tautan_percakapan ?? '#' }}"
                                                    class="text-blue-500">Lihat Percakapan</a></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><img
                                                    src="{{ $pengaduan->tangkapan_layar ?? '#' }}"
                                                    alt="Tangkapan Layar" class="w-16 h-16 object-cover"></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                {{ $pengaduan->petugas_pelayanan ?? 'N/A' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                {{ $pengaduan->status }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
