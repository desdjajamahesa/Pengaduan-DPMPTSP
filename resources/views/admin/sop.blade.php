                    ...
                    <div class="container mx-auto px-4 py-6">
                        ...
                        <div class="bg-white shadow-md rounded-lg overflow-hidden">
                            <table
                                ...
                                <thead class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                                    <tr>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @if ($sops->isEmpty())
                                        <tr>
                                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">Tidak ada SOP
                                                yang ditemukan.
                                            </td>
                                        </tr>
                                    @else
                                        @foreach ($sops as $sop)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <!-- Hapus Button -->
                                                    <form method="POST"
                                                        action="{{ route('admin.sop.destroy', $sop->id) }}"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
