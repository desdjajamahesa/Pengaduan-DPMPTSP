<div class="flex-1 flex flex-col" x-data="{ menuOpen: false }">
    ...
    <nav x-show="menuOpen" x-transition
        ...
        <ul class="flex flex-col space-y-2 p-4">
            ...
            <li><a
                    href="/users"class="flex items-center font-semibold py-3 px-8 rounded-md hover:bg-cyan-600 hover:text-white transition ease-in-out duration-200 w-full">Pelapor</a>
            </li>
            <li><a href="/pengaduan"
            ...
            <li><a
                    href="/sop"class="flex items-center font-semibold py-3 px-8 rounded-md hover:bg-cyan-600 hover:text-white transition ease-in-out duration-200 w-full">SOP</a>
            </li>
            <li><a href="/kontak"
