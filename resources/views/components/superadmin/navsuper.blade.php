    ...
    <aside id="sidebar"
        ...
        <nav class="mt-8">
            <a href="/super-dashboard"
                class="flex items-center font-semibold py-3 px-8 rounded-md hover:bg-cyan-600 hover:text-white transition ease-in-out duration-200">
                <svg class="w-6 h-5 mr-5 text-gray-200" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512">
                    <path
            ...
            <a href="/profile-super"
                ...
                <svg class="w-6 h-5 mr-5 text-gray-200" fill="currentColor" stroke="currentColor"
            ...
            <form action="{{ route('logout') }}" method="POST" class="mt-2">
                ...
                <button type="submit"
                    class="flex items-center font-semibold py-3 px-8 rounded-md hover:bg-cyan-600 hover:text-white transition ease-in-out duration-200">
                    <svg class="w-6 h-6 mr-5 text-gray-200" fill="currentColor" stroke="currentColor"
