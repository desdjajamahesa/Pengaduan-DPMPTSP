<div class="min-h-screen flex">
    <aside class="w-64 bg-gray-900 text-white shadow-lg">
        <div class="p-6 text-xl font-bold border-b border-gray-700">SuperAdmin Dashboard</div>
        <nav class="mt-6">
            ...
            <a href="/usersuper"
                ...
                <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 7v10l5-5 5 5V7l-5 5L4 7z"></path>
                </svg>
                Users
            </a>
            <a href="/pengaduansuper"
                ...
                <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16v8H4V8z"></path>
                </svg>
                Pengaduan
            </a>
            <a href="/sopsuper"
